...
<%
	...
	*/
	...
	String price = request.getParameter("submitsum");
									...
									<td style="text-align:left;">
										<form id="SendPayForm_id" name="" method="POST" hidden>
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br/><b>goodname</b> :
												<br/><input  style="width:100%;" name="goodname" value="<%=name%>" >
												...
												<br/><b>returnUrl</b> :
												<br/><input  style="width:100%;" name="returnUrl" value="<%=siteDomain%>/CartPaySuccess.do?<%=prods%>&price=<%=price%>" >
												<!--
