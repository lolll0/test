...
<%
	...
	*/
	...
	//INIStdPayRequest2.jsp
// 	String price =  request.getAttribute("sum").toString();
	
	String price = request.getParameter("submitsum");	// 상품가격(특수기호 제외, 가맹점에서 직접 설정)
...
//   	int point = loginmember.getMember_point();
    ...
    String customerno = ""+cusno; //회원 customerno
									...
									<td style="text-align:left;">
										<form id="SendPayForm_id" name="" method="POST" hidden>
											...
											<div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
												...
												<br/><b>returnUrl</b> :
												<br/><input  style="width:100%;" name="returnUrl" value="<%=siteDomain%>/MemberPaySuccess.do?cno=<%=customerno%>&conprodno=<%=conprodno%>" >
												<!--
