...
public class ArrayListTest01 {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("DDDD위치 : " + list2.indexOf("DDDD")); //존재하는 위치의 index값을 반환
	    System.out.println("ZZZZ위치 : " + list2.indexOf("ZZZZ")); //존재하지 않기 때문에 -1을 반환한다.
	    System.out.println();
	    
	    System.out.println("list2 => " + list2);
	    System.out.println("BBBB의 위치 : " + list2.indexOf("BBBB")); //앞에서부터
		System.out.println("BBBB의 위치 : " + list2.lastIndexOf("BBBB")); //뒤에서부터
		System.out.println("-------------------------------------------");
...
//		String[] strArr = (String[]) list2.toArray(); 오류발생
