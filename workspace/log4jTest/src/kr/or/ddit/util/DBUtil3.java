...
//(ResourceBundle객체로 properties파일의 내용을 읽어와 설정하기)
public class DBUtil3 {
	...
	static {
		...
		logger.info("ResourceBundle객체 생성 -> dbinfo.properrties파일 읽기");
...
//			Class.forName("oracle.jdbc.driver.OracleDriver");
	...
	public static Connection getConnection() {
		...
		try {
//			return DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "cmg90", "java");
