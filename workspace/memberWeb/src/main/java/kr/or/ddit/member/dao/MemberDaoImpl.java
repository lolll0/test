...
public class MemberDaoImpl implements IMemberDao {
	...
	@Override
	public int getMemberCount(SqlMapClient smc, Map<String, String> searchMap) throws SQLException {
		int cnt = (int)smc.queryForObject("mymember.getMemberCount", searchMap);
			
		return cnt;
	}

	@Override
	public List<MemberVO> getMemberList(SqlMapClient smc, Map<String, String> searchMap) throws SQLException {
		List<MemberVO> memList = smc.queryForList("mymember.getMemberList", searchMap);
