...
/*
 	Generic클래스 만드는 방법
 	형식)
 	  class 클래스명<제네릭타입글자>{ // 제네릭타입글자는 보통 대문자 한글자를 사용한다.
 	  	private 제네릭타입글자 변수명;  // 변수 선언에 제네릭을 사용하는 경우
 	  	...
 	  	...
 	  	void 메서드명(제너릭타입글자 변수명){ // 메서드의 매개변수에 제네릭 사용하기
 	  		...
 	  	}
...
public class GenericTest {
	...
	public static void main(String[] args) {
		...
		int rtnNg2 = (Integer)ng2.getValue();
		System.out.println("정수형 반환값 rtnNg2 => " + rtnNg2);
		System.out.println();
		System.out.println("------------------------------------");
		
		MyGeneric<String> mg1 = new MyGeneric<>(); // T가 String타입으로 된다.
		mg1.setValue("안녕하세요");
		
		MyGeneric<Integer> mg2 = new MyGeneric<>(); // T가 Integer타입
		mg2.setValue(500);
